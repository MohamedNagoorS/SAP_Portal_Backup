class ZCL_ZMAINTENANCE_829_O_DPC_EXT definition
  public
  inheriting from ZCL_ZMAINTENANCE_829_O_DPC
  create public .
...
CLASS ZCL_ZMAINTENANCE_829_O_DPC_EXT IMPLEMENTATION.


  method ZMAINT_LOGIN_829_GET_ENTITY.
**TRY.
*CALL METHOD SUPER->ZMAINT_LOGIN_829_GET_ENTITY
*  EXPORTING
*    IV_ENTITY_NAME          =
*    IV_ENTITY_SET_NAME      =
*    IV_SOURCE_NAME          =
...
**ENDTRY.
    ...
    DATA: ls_key_tab TYPE /iwbep/s_mgw_name_value_pair,
          lv_userid  TYPE z_username_829_de,
          ls_res     TYPE zmaintenance_login_829_s.
    ...
    IF lv_userid IS NOT INITIAL.
      " 2. Select Data
      SELECT SINGLE * FROM zdt_mant_crd_829 INTO CORRESPONDING FIELDS OF ls_res
...
METHOD zmaint_notificat_get_entityset.
    DATA: lv_engineer TYPE z_username_829_de,
          lt_plant    TYPE zmaintenance_plant_829_t,
          lt_notif    TYPE zmaintenance_notif_829_t,
          lt_temp_notif TYPE zmaintenance_notif_829_t. " Temporary table for the loop
    ...
    IF lv_engineer IS NOT INITIAL.
      ...
      TRY.
          ...
          zmaint_amdp_829=>get_plant_details(
            EXPORTING
              iv_client   = sy-mandt
          ...
          LOOP AT lt_plant INTO DATA(ls_plant_row).
            ...
            zmaint_amdp_829=>get_notifications(
              EXPORTING
                iv_client = sy-mandt
...
**TRY.
*CALL METHOD SUPER->ZMAINT_PLANT_829_GET_ENTITYSET
*  EXPORTING
*    IV_ENTITY_NAME           =
*    IV_ENTITY_SET_NAME       =
*    IV_SOURCE_NAME           =
...
**ENDTRY.
    ...
    IF lv_engineer IS NOT INITIAL.
      TRY.
        CALL METHOD zmaint_amdp_829=>get_plant_details
          EXPORTING
            iv_client   = sy-mandt
            iv_engineer = lv_engineer
          IMPORTING
...
**ENDTRY.
    ...
    DATA: lv_engineer     TYPE z_username_829_de,
          lt_plant        TYPE zmaintenance_plant_829_t,
          lt_temp_orders  TYPE zmaintenance_workorder_829_t.
    ...
    IF lv_engineer IS NOT INITIAL.
      ...
      TRY.
          ...
          LOOP AT lt_plant INTO DATA(ls_plant_row).
            ...
            zmaint_amdp_829=>get_work_orders(
              EXPORTING
                iv_client = sy-mandt
                iv_plant  = ls_plant_row-werks
              IMPORTING
