CLASS zmaint_amdp_829 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  INTERFACES if_amdp_marker_hdb.
    ...
    TYPES: tt_plant      TYPE zmaintenance_plant_829_t,
           tt_notif      TYPE zmaintenance_notif_829_t,
           tt_workorder  TYPE zmaintenance_workorder_829_t.


    CLASS-METHODS get_plant_details
      IMPORTING VALUE(iv_client)   TYPE mandt
                VALUE(iv_engineer) TYPE z_username_829_de
...
CLASS zmaint_amdp_829 IMPLEMENTATION.

  METHOD get_plant_details BY DATABASE PROCEDURE FOR HDB
                           LANGUAGE SQLSCRIPT
                           OPTIONS READ-ONLY
                           USING zdt_plant_829 t001w.
