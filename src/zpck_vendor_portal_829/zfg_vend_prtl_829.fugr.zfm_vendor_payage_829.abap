FUNCTION ZFM_VENDOR_PAYAGE_829.
*"----------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
*"     VALUE(IV_VENDOR_ID) TYPE  LIFNR
*"  EXPORTING
*"     VALUE(ET_PAYAGE) TYPE  ZVENDORPAYAGE_829_T
*"----------------------------------------------------------------------



DATA: lv_vendor_id TYPE lifnr,ls_row   TYPE ZVENDORPAYAGE_829_S,
        lv_aging TYPE i..
  CALL FUNCTION 'CONVERSION_EXIT_ALPHA_INPUT'
    ...
    IMPORTING
      output = lv_vendor_id.
  CALL METHOD zvend_payage_829=>get_data
    EXPORTING
