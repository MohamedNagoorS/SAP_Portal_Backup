class ZCL_ZEMPLOYEE_829_O_01_DPC_EXT definition
  public
  inheriting from ZCL_ZEMPLOYEE_829_O_01_DPC
  create public .
...
CLASS ZCL_ZEMPLOYEE_829_O_01_DPC_EXT IMPLEMENTATION.
...
* Get Adobe Form function module
  CALL FUNCTION 'FP_FUNCTION_MODULE_NAME'
    EXPORTING i_name = 'ZF_EMPLOYEE_PAYSLIP_829'
...
**  CATCH /iwbep/cx_mgw_tech_exception.
**ENDTRY.
CALL METHOD zemp_leave_request_829=>get_leave_data
  EXPORTING
    iv_client = sy-mandt
  IMPORTING
...
**TRY.
*CALL METHOD SUPER->ZEMP_PAYSLIP_829_GET_ENTITYSET
*  EXPORTING
*    IV_ENTITY_NAME           =
*    IV_ENTITY_SET_NAME       =
*    IV_SOURCE_NAME           =
...
**ENDTRY.
    ...
    IF lv_pernr IS NOT INITIAL.
      TRY.
CALL METHOD zemp_payslip_829=>get_payslip_data
  EXPORTING
    iv_client = sy-mandt
    iv_pernr  = lv_pernr
  IMPORTING
...
**TRY.
*CALL METHOD SUPER->ZEMP_PROFILE_829_GET_ENTITYSET
*  EXPORTING
*    IV_ENTITY_NAME           =
*    IV_ENTITY_SET_NAME       =
*    IV_SOURCE_NAME           =
...
**ENDTRY.
    ...
    TRY.
        CALL METHOD zemp_profile_829=>get_profile_data
          EXPORTING
            iv_client = sy-mandt
          IMPORTING
            et_data   = et_entityset.
