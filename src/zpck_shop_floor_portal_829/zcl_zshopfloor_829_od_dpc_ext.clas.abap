class ZCL_ZSHOPFLOOR_829_OD_DPC_EXT definition
  public
  inheriting from ZCL_ZSHOPFLOOR_829_OD_DPC
  create public .
...
CLASS ZCL_ZSHOPFLOOR_829_OD_DPC_EXT IMPLEMENTATION.
...
**ENDTRY.
    DATA: lv_user TYPE ZDT_SF_LOGIN_829-empid,
        lv_password TYPE ZDT_SF_LOGIN_829-PASSWORD,
        lv_message  TYPE string,
        lt_key_tab  TYPE /iwbep/t_mgw_tech_pairs,
        ls_key      TYPE /iwbep/s_mgw_tech_pair,
        ls_login    TYPE ZDT_SF_LOGIN_829.
  ...
  SELECT SINGLE * INTO @ls_login FROM ZDT_SF_LOGIN_829
...
**  CATCH /iwbep/cx_mgw_tech_exception.
**ENDTRY.
    DATA: lt_amdp_data TYPE ZSHOPFLOOR_PLANORDER_829_T.
    CALL METHOD zshopfloor_amdp_829=>get_planned_orders
      EXPORTING
        iv_client = sy-mandt
      IMPORTING
...
**  CATCH /iwbep/cx_mgw_tech_exception.
**ENDTRY.
    DATA: lt_amdp_data TYPE ZSHOPFLOOR_PRODORDER_829_T.
CALL METHOD zshopfloor_amdp_829=>get_prod_orders
  EXPORTING
    iv_client = sy-mandt
  IMPORTING
    et_orders = lt_amdp_data
