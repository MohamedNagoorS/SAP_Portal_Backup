CLASS zehsm_amdp_829 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  INTERFACES if_amdp_marker_hdb.
    ...
    CLASS-METHODS get_profile
      ...
      EXPORTING
        VALUE(et_profile)    TYPE ZEHSM_PROFILE_829_T.
    ...
    CLASS-METHODS get_incidents
      ...
      EXPORTING
        VALUE(et_incidents)  TYPE zehsm_incident_829_t.
    ...
    CLASS-METHODS get_risks
      IMPORTING
        ...
        VALUE(iv_employeeid) TYPE persno
      EXPORTING
        VALUE(et_risks)      TYPE zehsm_risk_829_t.
...
CLASS zehsm_amdp_829 IMPLEMENTATION.
