class ZCL_ZEHSM_829_OD_DPC_EXT definition
  public
  inheriting from ZCL_ZEHSM_829_OD_DPC
  create public .
...
CLASS ZCL_ZEHSM_829_OD_DPC_EXT IMPLEMENTATION.
...
**ENDTRY.
  ...
  DATA: lv_empid    TYPE persno,
        lt_inc      TYPE zehsm_incident_829_t,
        ls_inc      TYPE zehsm_incident_829_s.
...
CALL METHOD zehsm_amdp_829=>get_incidents
  EXPORTING
    iv_client     = sy-mandt
...
**TRY.
*CALL METHOD SUPER->ZEHSM_LOGIN_829S_GET_ENTITY
*  EXPORTING
*    IV_ENTITY_NAME          =
*    IV_ENTITY_SET_NAME      =
*    IV_SOURCE_NAME          =
...
DATA: lv_employee_id TYPE Z_USERNAME_829_DE,
      lv_empid type pernr_d,
          lv_password  TYPE Z_USERPASS_829_DE.
...
lv_empid = |{ lv_employee_id WIDTH = 8 ALIGN = RIGHT PAD = '0' }|.
    SELECT SINGLE * FROM ZDT_EHSM_LGN_829 INTO @DATA(ls_auth)
...
**TRY.
*CALL METHOD SUPER->ZEHSM_PROFILE_82_GET_ENTITY
*  EXPORTING
*    IV_ENTITY_NAME          =
*    IV_ENTITY_SET_NAME      =
*    IV_SOURCE_NAME          =
...
**  CATCH /iwbep/cx_mgw_tech_exception.
**ENDTRY.
    DATA: ls_entity     TYPE ZEHSM_PROFILE_829_S,
        lt_profile    TYPE ZEHSM_PROFILE_829_T,
        lv_employeeid TYPE Z_USERNAME_829_DE,
        lv_empid type pernr_d,
 ...
 lv_empid = |{ lv_employeeid WIDTH = 8 ALIGN = RIGHT PAD = '0' }|.
  ...
  CALL METHOD zehsm_amdp_829=>get_profile
    EXPORTING
      iv_client     = sy-mandt
      iv_employeeid = lv_empid
    IMPORTING
...
**TRY.
*CALL METHOD SUPER->ZEHSM_RISK_829SE_GET_ENTITYSET
*  EXPORTING
*    IV_ENTITY_NAME           =
*    IV_ENTITY_SET_NAME       =
*    IV_SOURCE_NAME           =
...
**ENDTRY.
  ...
  DATA: lv_empid TYPE persno,
        lt_risk  TYPE zehsm_risk_829_t,
        ls_risk  TYPE zehsm_risk_829_s.
...
CALL METHOD zehsm_amdp_829=>get_risks
  EXPORTING
    iv_client     = sy-mandt
    iv_employeeid = lv_empid
  IMPORTING
